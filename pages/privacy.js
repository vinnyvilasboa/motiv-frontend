...
function privacy() {
  ...
  />
  <div data-custom-class="body" style={{margin:"20px"}}>
    <div>
      <strong>
        ...
        <strong>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="subtitle">
              Last updated <bdt className="question">July 20, 2022</bdt>
            </span>
          </span>
        </strong>
      </span>
      ...
      <span style={{ color: "rgb(127, 127, 127)" }}>
        <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
          <span data-custom-class="body_text">
            This privacy notice for <bdt className="question">Motiv Inc.</bdt>
    ...
    <div>
        ...
        <span style={{ fontSize: 15 }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span data-custom-class="body_text">
              ...
              <bdt className="question">motiv@joinmotiv.io</bdt>.
            </span>
          </span>
        </span>
      </div>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">
            ...
            <bdt className="block-component" />
            <bdt className="question">Motiv Inc.</bdt>
      ...
      <div style={{ lineHeight: "1.5" }}>
        ...
        <a
          data-custom-class="link"
          href="https://app.termly.io/notify/2b296086-e801-4ad6-81c2-e8e23b3280bf"
          ...
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    <bdt className="question">company</bdt>
                  </span>
                </span>
              </span>
            </span>
          ...
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    <bdt className="question">videos</bdt>
                  </span>
                </span>
              </span>
            </span>
                              ...
                              <div style={{ lineHeight: "1.5" }}>
                                <span style={{ fontSize: 15 }}>
                                  <span data-custom-class="body_text">
                                    ...
                                    agents (<bdt className="block-component" />"
                                    ...
                                    safeguard your personal information. This
                                    means that they cannot do anything with your
                                    personal information unless we have
                                    instructed them to do it. They will also not
                                  ...
                                  <li style={{ lineHeight: "1.5" }}>
                                    <span style={{ fontSize: 15 }}>
                                      <span data-custom-class="body_text">
                                        ...
                                        honor
                                        <bdt className="statement-end-if-in-editor" />{" "}
                                        this privacy notice. Affiliates include
                                        our parent company and any subsidiaries,
                                  ...
                                  <div style={{ lineHeight: "1.5" }}>
                                    ...
                                    <span style={{ fontSize: 15 }}>
                                      <span data-custom-class="body_text">
                                        ...
                                        send you service-related messages that
                                    ...
                                    >
                                      ...
                                      >
                                        <span data-custom-class="body_text">
                                          ...
                                          cookies or reject cookies, this could
                                          affect certain features or services of
                                          our Services. To opt out of
                                    ...
                                    >
                                      ...
                                      >
                                        <span data-custom-class="body_text">
                                          ...
                                          to signal your privacy preference not
                                          to have data about your online
                                    ...
                                    >
                                      ...
                                      >
                                        <span data-custom-class="body_text">
                                          ...
                                          registered account with Services, you
                                    ...
                                    >
                                      ...
                                      >
                                        <span data-custom-class="body_text">
                                          ...
                                          authorized
                                          <bdt className="statement-end-if-in-editor" />{" "}
                                          agent to exercise your right to opt
                                          out we may deny a request if the{" "}
                                          <bdt className="block-component" />
                                          authorized
                                          <bdt className="statement-end-if-in-editor" />{" "}
                                  ...
                                  <div style={{ lineHeight: "1.5" }}>
                                    ...
                                    <span data-custom-class="body_text">
                                      <span style={{ fontSize: 15 }}>
                                        ...
                                        has not sold any personal information to
                                              ...
                                              <div>
                                                ...
                                                >
                                                  ...
                                                  <span data-custom-class="body_text">
                                                    ...
                                                    bottom of this document. If
                                                    you have a complaint about
                                                    how we handle your data, we
