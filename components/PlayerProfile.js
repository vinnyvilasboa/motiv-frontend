                ...
                <Container fluid>
                    <Row className="player-outer" style={{height:"100vh", margin:"auto 0"}}>
                        <div className="player-inner-container" style={{ display: "flex" }}>
                            <Col className="player-left" style={{marginLeft: "20px", justifyContent:"center"}}>
                            ...
                            <Col className="player-right"  style={{justifyContent:"center", alignItems:"center", margin:"auto 0"}}>
                                <Image src={PlayerPic} width="800" height="1000"></Image>
                            </Col>
                        </div>
                    </Row>
                </Container>
