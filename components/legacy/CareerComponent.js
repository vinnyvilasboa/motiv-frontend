			...
			<div className="career-bg">
				<Container fluid>
					<Row className="career-top" style={{ marginBottom: "30px" }}>
						...
						<Col xs={10} className="career-title">
							...
							>
								...
								schedule and fine time to identify job opportunities
							</h1>
							<p
								style={{
									fontSize: "1.2rem",
							...
							>
								We aim to bridge the gap between a collegiate athletic career
								and your next professional journey by bringing opportunities to
								you.
							</p>
						</Col>
						<Col></Col>
					...
					<Row className="career-bottom">
						<div
							className="career-bottom-container"
							style={{ display: "flex" }}
						>
							...
							>
								<h1 style={{ paddingBottom: "20px", fontSize: "3.5rem" }}>
